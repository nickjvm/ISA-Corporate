<?php
if(preg_match('/mobi/',$_SERVER['HTTP_REFERER'])) {
	setcookie('mobilepref','nomobile', time()+3600);
}
$useragent=$_SERVER['HTTP_USER_AGENT'];

if($_GET['mobile']==1) {
	setcookie('mobilepref','mobile', time()+3600);
}
if($_GET['mobile'] != 0 || !isset($_GET['mobile'])) {
	if($_COOKIE['mobilepref'] != "nomobile") {
		...
		setcookie('mobilepref',"mobile", time()+3600);
		header('Location: http://iasoybeans.mobi');
		//echo $_COOKIE['mobilepref'];
